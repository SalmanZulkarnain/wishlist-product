      ...
      <div class="form-container">
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="input-group">
            <input type="text" name="nama_barang" placeholder="Masukkan nama barang" value="<?php echo $product_edit ? $product_edit['nama_barang'] : ''; ?>" />
          </div>
          <div class="input-group">
            <input type="text" name="url_barang" placeholder="Masukkan url barang" value="<?php echo $product_edit ? $product_edit['url_barang'] : ''; ?>" />
          </div>
          <div class="input-group">
            <select name="status">
          ...
          <div class="card">
            ...
            <div class="card-content-footer">
              ...
              <div class="card-footer">
                ...
                <a href="index.php?delete=<?php echo $product['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus?')"><i class="fa-solid fa-trash"></i></a>
              </div>
            </div>
          </div>
        <?php } ?>
